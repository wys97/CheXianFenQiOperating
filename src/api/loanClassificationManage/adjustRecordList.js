 ...
 * @param status 阶段状态
 */
export function getListData ({limit,page,financeNo,supplierName,loanClassificationBefore,loanClassificationAfter}) {
  const data = {
    limit,
    page,
    financeNo,
  ...
  return fetch({
    url: test + '/admin/loan_classification/adjust_record_list',
    method: 'post',
    data
  })
}
