<template>
  <div class="container">
    ...
    <div class="top">
      <ul class="flex-item">
        <li>{{financeDetailHead.supplierName}}</li>
        <li></li>
        <li>
          融资单号：{{financeDetailHead.financeNo}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          融资金额: {{financeDetailHead.financeAmt}}
        </li>
      ...
      <div class="flex-item">
        <el-steps
          :active="1"
          v-if="(status === 'INVALID'||status === 'FAIL'||status === 'FINANCE_AUDIT_REFUSE')"
          finish-status="error"
          :align-center="true"
        >
          <el-step
            :title="status === 'INVALID'?'失效':status === 'FAIL'?'融资失败':status === 'FINANCE_AUDIT_REFUSE'?'融资审核拒绝':'异常'"
          >
            <div slot="description" class="status">
              <div class="tip">
                <span
                  style="background-color: transparent;border: 1px solid #f56c6c; color: #f56c6c;"
                >{{statusText}}</span>
              </div>
        ...
        <el-steps
          v-else
          :active="statusActive"
          :process-status="status === 'SUCCESS' ? 'finish': status === 'FAIL' ? 'error': 'process'"
          :align-center="true"
        >
          <el-step title="待商户签署">
          ...
          <el-step :title="status === 'SUCCESS'? '融资成功':'融资成功'">
            <div slot="description" class="status" v-if="status === 'SUCCESS'">
              <div class="tip" :class="status === 'SUCCESS'?'tipSuc':''">
                <span>{{statusText}}</span>
              </div>
              <i class="el-icon-caret-bottom"></i>
            </div>
    ...
    <div class="content">
      <div class="flex-item" style="position: relative;">
        ...
        <el-tabs v-model="activeName2" type="card">
              ...
              <div class="core-enterprise info-list">
                ...
                <div class="table_top">
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeNo?financeDetail.financeNo:'--'}}</el-col>
                    <el-col :span="4" class="grid-content bg_left">场景方名称：</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeNo?financeDetail.financeNo:'--'}}</el-col>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.supplierName?financeDetail.supplierName:'--'}}</el-col>
                  ...
                  <el-row>
                    <el-col :span="4" class="grid-content bg_left">对接产品：</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeMethodText?financeDetail.financeMethodText:'--'}}</el-col>
                    <el-col :span="4" class="grid-content bg_left">授信期限至：</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeMethodText?financeDetail.financeMethodText:'--'}}</el-col>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeAmt?financeDetail.financeAmt:'--'}}</el-col>
                    <el-col :span="4" class="grid-content bg_left">剩余可用授信额度</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.financeMonths?financeDetail.financeMonths:'--'}}</el-col>
                  </el-row>
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.repaymentMethod?financeDetail.repaymentMethod:'--'}}</el-col>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.loanRate?financeDetail.loanRate:'--'}}%</el-col>
                    <el-col :span="4" class="grid-content bg_left">总利息：</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.interest?financeDetail.interest:'--'}}</el-col>
                  </el-row>
                  <el-row>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.feeRate?financeDetail.feeRate:'--'}}%</el-col>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.marginRate?financeDetail.marginRate:'--'}}%</el-col>
                    <el-col :span="4" class="grid-content bg_left">保证金：</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.cashDeposit?financeDetail.cashDeposit:'--'}}</el-col>
                  </el-row>
                  <el-row>
                    ...
                    <el-col
                      :span="20"
                      class="bg_right"
                    >{{financeDetail.totalAmt?financeDetail.totalAmt:'--'}}</el-col>
                    <el-col :span="4" class="grid-content bg_left">保证金余额：</el-col>
                    <el-col
                      :span="20"
                      class="bg_right"
                    >{{financeDetail.totalAmt?financeDetail.totalAmt:'--'}}</el-col>
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="20"
                      class="bg_right"
                    >{{financeDetail.applyTime?financeDetail.applyTime:'--'}}</el-col>
                  </el-row>
                  <!--<el-row >
                  ...
                  <el-row>
                    ...
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.capitalName?financeDetail.capitalName:'--'}}</el-col>
                    <el-col :span="4" class="grid-content bg_left">签约方式</el-col>
                    <el-col
                      :span="8"
                      class="bg_right"
                    >{{financeDetail.signTypeText?financeDetail.signTypeText:'--'}}</el-col>
                  </el-row>
                  <el-row>
                    ...
                    <el-col
                      :span="20"
                      class="bg_right"
                    >{{financeDetail.loanTime?financeDetail.loanTime:'--'}}</el-col>
                  </el-row>
                </div>
                ...
                <div class="table_top account_table">
                  <el-row class="account_table_tbody">
                    ...
                    <el-col :span="5" class="account_th">计划还款日期</el-col>
                    <el-col :span="5" class="account_th">计划还款本金</el-col>
                    <el-col :span="4" class="account_th">计划还款利息</el-col>
                    <el-col :span="3" class="account_th">计划还款总金额</el-col>
                    <el-col :span="5" class="account_th">还款状态</el-col>
                  </el-row>
                  <div v-for="(item,index) in backPlanList">
                    <el-row class="account_table_thead">
                      <el-col :span="2" class="account_td">{{index+1}}</el-col>
                      <el-col :span="5" class="account_td">{{item.planDate?item.planDate:'--'}}</el-col>
                      <el-col :span="5" class="account_td">{{item.amount?item.amount:'--'}}</el-col>
                      <el-col :span="4" class="account_td">{{item.interest?item.interest:'--'}}</el-col>
					            <el-col :span="3" class="account_td">{{item.planAmt?item.planAmt:'--'}}</el-col>
					            <el-col :span="5" class="account_td">{{item.statusText?item.statusText:'--'}}</el-col>
                    </el-row>
                  </div>
                </div>
                <!-- 当订单融的时候才显示应收账款 -->
                    ...
                    <div v-for="(item,index) in financeDetailReceivables">
                      <el-row class="account_table_thead">
                        ...
                        <el-col
                          :span="4"
                          class="account_td"
                        >{{item.receivableNo?item.receivableNo:'--'}}</el-col>
                        ...
                        <el-col
                          :span="3"
                          class="account_td"
                        >{{item.returnDate?item.returnDate:'--'}}</el-col>
                        <el-col :span="2" class="account_td">
                          <router-link
                            :to="'/accountManage/accountDetail/' + item.receivableNo"
          ...
          <el-tab-pane v-if="riskResult.bankRlt!=='HIDDEN'&&false" label="银行流水信息" name="second">
            <div class="tab-content">
              <el-form
                ref="form1"
                class="viewBankserialForm"
                label-width="125px"
                size="mini"
              ...
              >
                <div class="info-list">
                  ...
                  <el-row style="text-align: center;">
                    <el-col :span="5">应收账款编号:</el-col>
                    <el-col :span="4">转账时间:</el-col>
                    <el-col :span="4">流水号:</el-col>
                    <el-col :span="4">转账金额（元）:</el-col>
                  ...
                  <template v-for="(item, index) in viewBankserial.bankSerial">
                    <el-row>
                      ...
                      <el-col :span="4" style="text-align: center;">
                        <Upload
                          v-model="item.bankSerialKey"
                          :fileUrl="item.bankSerialUrl"
                          :dataObj="uploadImgData"
                          actionUrl="/admin/finance/upload_bankserial"
                        ></Upload>
                        <span
                          @click="lookImg(item.bankSerialUrl)"
                          style="position: absolute; right:8%;top: 90px; cursor: pointer;color: #1482F0;"
                        >查看截图>></span>
                      </el-col>
                    </el-row>
                  </template>
                ...
                <div class="info-list" style="text-align: right;">
                  <el-button
                    v-if="!roleHasPermissions['finance_manage_register_list_audit']"
                    @click="resetBankserial"
                  >重置</el-button>
                  <el-button
                    v-if="!roleHasPermissions['finance_manage_register_list_audit']"
                    @click="saveBankserial"
                    type="primary"
                  >保存</el-button>
                </div>
              </el-form>
          ...
          <template v-if="false">
            <li v-if="riskResult.bankRlt!=='HIDDEN'" class="color-black" @click="bankSerialMatch">
              <div>
                ...
                <p
                  v-else-if="riskResult.bankRlt=='ABNORMAL'"
                  class="fail"
                >异常 {{riskResult.bankUnMatch}}条</p>
                <p v-else-if="riskResult.bankRlt=='NO_RECORD'" class="fail">无记录</p>
              </div>
              <div>
            ...
            <li class="color-black" @click="tradeMatch">
              <div>
                ...
                <p
                  v-else-if="riskResult.tradeRlt=='ABNORMAL'"
                  class="fail"
                >异常 {{riskResult.tradeUnMatch}}条</p>
                <p v-else-if="riskResult.tradeRlt=='NO_RECORD'" class="fail">无记录</p>
              </div>
              <div>
                <i class="el-icon-arrow-right"></i>
              </div>
    ...
    >
      <div class="dialog-content">
        <div class="tip">
          <p v-if="riskResult.bankRlt=='NORMAL'" class="suc">正常</p>
          <p v-else-if="riskResult.bankRlt=='ABNORMAL'" class="fail">异常 {{riskResult.bankUnMatch}}条</p>
          <p v-else-if="riskResult.bankRlt=='NO_RECORD'" class="fail">无记录</p>
        </div>
        <div style="line-height: 40px;">银行流水匹配</div>
        <template>
          <el-table :data="bankSerialMatchDetails" border style="width: 100%;text-align: center;">
            <el-table-column prop="receivableNo" label="应收账款编号"></el-table-column>
            <el-table-column prop="strikeAmt" label="平台数据"></el-table-column>
            <el-table-column prop="transferAmt" label="银行流水"></el-table-column>

            <el-table-column prop="status" label="匹配">
              <template slot-scope="scope">
                <div v-if="scope.row.status == '匹配'">匹配</div>
                <div v-else>
                ...
                <el-collapse-item>
                  <template slot="title">
                    ...
                    <span
                      ...
                      :class="item.riskNumber==0?'suc':'fail'"
                    >异常{{item.riskNumber}}条</span>
                    <i class="header-icon"></i>
                  </template>
                  <div class="el_row" v-for="listItem in item.list">
                    <el-row>
                      <el-col :span="16">{{listItem.auditItems}}</el-col>
                      <el-col
                        :span="4"
                        class="span4"
                        :class="listItem.whetherRisk=='green'?'suc':'fail'"
                      >{{listItem.historicalOccurrence}}</el-col>
                      <el-col
                        :span="4"
                        class="span4"
                        :class="listItem.whetherRisk=='green'?'suc':'fail'"
                      >{{listItem.historyAccountsFor}}</el-col>
                    </el-row>
                  </div>
                </el-collapse-item>
              </div>
...
import financeDetailApi from "@/api/financeManage/financeDetail";
...
export default {
  ...
  methods: {
    ...
    getComboboxBankList() {
      financeDetailApi.comboboxBankList().then(res => {
    ...
    getFinanceDetail() {
      let that = this;
      financeDetailApi.financeDetail(this.financeNo).then(res => {
        if (res.data.code === "200") {
          ...
          this.financeDetailReceivables =
            res.data.data.financeDetailReceivables;
    ...
    getRepaymentPlan() {
      financeDetailApi.repaymentPlan(this.financeNo).then(res => {
        if (res.data.code === "200") {
          this.backPlanList = res.data.data;
        } else {
          this.$message.error(res.data.message);
        }
        console.log(res);
    ...
    getRiskResult() {
      financeDetailApi.riskResult(this.financeNo).then(res => {
        if (res.data.code === "200") {
    ...
    getViewBankserial() {
      ...
      financeDetailApi.viewBankserial(financeNo)
        .then(res => {
          if (res.data.code === "200") {
    ...
    getBankSerialMatch() {
      let that = this;
      let financeNo = this.financeNo;
      financeDetailApi.bankSerialMatch(financeNo)
        .then(res => {
          if (res.data.code === "200") {
            if (res.data.data != null) {
    ...
    getTradeMatch() {
      let that = this;
      let financeNo = this.financeNo;
      financeDetailApi.tradeMatch(financeNo)
        .then(res => {
          if (res.data.code === "200") {
            if (res.data.data != null) {
    ...
    saveBankserial() {
      ...
      financeDetailApi.saveBankserial(data)
        .then(res => {
          if (res.data.code === "200") {
            this.$message.success(res.data.message);
            this.getBankSerialMatch(); //银行流水匹配刷新
            this.getRiskResult(); //操作刷新
          } else {
            this.$message.error(res.data.message);
          }
        })
    ...
    viewFinanceContract() {
      //查看融资协议
      let financeNo = this.financeNo;
      financeDetailApi.viewFinanceContract(financeNo)
        .then(res => {
          if (res.data.code === "200") {
    ...
    approveFinal(type) {
      ...
      if (!type) {
        ...
        financeDetailApi.financeAuditRefuse(data)
          .then(res => {
            if (res.data.code === "200") {
        ...
        // 通过提交
        financeDetailApi.financeAuditPass(financeNo)
          .then(function(res) {
            if (res.data.code === "200") {
              that.$message.success(res.data.message);
              that.getFinanceDetail();
