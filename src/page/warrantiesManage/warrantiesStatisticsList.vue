  ...
  <div class="page-container" ref="page-container" id="page-container"><!---商户管理-商户入驻--->
    <div class="filter-container" ref="filter-container" id="filter-container">
      <el-form :inline="true" :model="listQuery" ref="listQueryForm">
        <el-form-item label="企业名称：" prop="guarantorName">
          <el-input v-model="listQuery.guarantorName" style="width:120px;"></el-input>
        </el-form-item>
        <!--<el-form-item label="社会统一代码：" prop="guarantorIdcardNo">
        ...
        <el-form-item label="社会统一代码：" prop="guarantorMobile">
          <el-input v-model="listQuery.guarantorMobile" style="width:130px;"></el-input>
        </el-form-item>
    ...
    <el-table :data="list"  @current-change="handleSelectionChange" highlight-current-row  :max-height=tableMaxHeight>
      ...
      <!--<el-table-column
        ...
        <template slot-scope="scope" v-if="!roleHasPermissions['supplier_manage_register_list_view']">
            <router-link :to="'guarantorDetail/' + scope.row.guarantorId" class="router-link">查看</router-link>
        </template>
      </el-table-column>-->
...
<script>
  ...
  import { getListData,collateralRegisterStatus} from '@/api/warrantiesManage/warrantiesStatisticsList'
