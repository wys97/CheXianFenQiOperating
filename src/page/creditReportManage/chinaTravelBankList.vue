<template>
  <div class="page-container" ref="page-container" id="page-container"><!-- 授信报告管理-中旅银行 -->
...
<script>
  ...
  import { getListData,customerType2,approveStatus} from '@/api/creditReportManage/chinaTravelBankList'
  ...
  export default {
    ...
    mounted () {
      this.getList()
      this.getApproveStatus(); // 获取审核状态下拉
      this.getCustomerTypeList (); // 获取客户类型下拉
      setTimeout(() => {
