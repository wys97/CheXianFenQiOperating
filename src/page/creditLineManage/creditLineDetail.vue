	...
	<div class="container">
		...
		<div class="top">
			<ul class="flex-item" v-if="basicData">
				<li>{{basicData.enterpriseName}}</li>
				<li>授信资方：{{basicData.capitalName}}</li>
			</ul>
		</div>
		<div class="content">
			<div class="flex-item" style="position: relative;width: 100%;">
				<el-tabs v-model="activeTab" type="card" @tab-click="handleClick">
					<el-tab-pane label="授信详情" name="first">
						<div class="tab-content" v-if="basicData">
							<el-form label-width="170px" size="mini" label-position="right">
								<div class="info-list">
									<div class="lh_title">授信详情</div>
									<el-row>
										<el-col :span="12">
											<el-form-item label="场景方名称：">
												<span class="input_read">{{basicData.enterpriseName}}</span>
											</el-form-item>
										</el-col>
										<el-col :span="12">
											<el-form-item label="场景统一信用代码：">
												<span class="input_read">{{basicData.supplierLicenseNo}}</span>
											</el-form-item>
										</el-col>
										<el-col :span="12">
									...
									<el-row>
										<el-col :span="12">
											<el-form-item label="资方名称：">
												<span class="input_read">{{basicData.capitalName}}</span>
											</el-form-item>
										</el-col>
										<el-col :span="12">
											<el-form-item label="资方统一信用代码：">
												<span class="input_read">{{basicData.capitalLicenseNo}}</span>
											</el-form-item>
										</el-col>
									</el-row>
									<el-row >
									...
									<el-form-item label="当前授信额度：">
										<span class="input_read">{{basicData.creditLine}} 元</span>
									</el-form-item>
									</el-col>
									<el-col :span="12">
									...
									<el-form-item label="状态：">
										<span class="input_read">{{basicData.creditStatusText}}</span>
									</el-form-item>
									<el-row>
										<el-col :span="12">
											<el-form-item label="开始日期：">
												<span class="input_read">{{basicData.creditBeginDate}}</span>
											</el-form-item>
										</el-col>
										<el-col :span="12">
											<el-form-item label="结束日期：">
												<span class="input_read">{{basicData.creditEndDate}}</span>
											</el-form-item>
										</el-col>
									</el-row>
									<el-form-item label="债权规模：">
										<span class="input_read">{{basicData.creditorCountryScale}} 元</span>
									</el-form-item>
									<el-form-item label="剩余可用授信额度：">
										<span class="input_read">{{basicData.surplusCreditLine}} 元</span>
									</el-form-item>
								</div>
								<div class="info-list">
									<div class="lh_title">授信额度调整登记</div>
									<div class="table_top" style="text-align: center;line-height: 40px;margin-bottom: 20px;">
										<el-row style="margin-bottom: 0;">
											<el-col :span="5" class="table_th">授信额度</el-col>
	...
	export default {
		...
		data() {
			return {
				...
				topData: '', //顶部数据
				basicData: '', //基础信息数据
				creditLineDetailRecordList: [], //授信额度调整记录
		...
		methods: {
			...
			doSaveCreditLineDetailRecordForm(){//保存授信额度调整记录
				...
				if((typeof this.creditLineDetailRecordForm.creditEndDate)==='object'&&this.creditLineDetailRecordForm.creditEndDate){
