		...
		<div class="content">
			<div class="flex-item" style="position: relative;">
				...
				<el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
					...
					<el-tab-pane label="终审备注" name="five">
						<div class="tab-content">
							<div class="info-list">
				...
				<ul>
					...
					<li v-if="checkHeadData.status==='PENDING'">
						<div class="fk_btn_box">
							<el-button @click="doPass" v-if="!roleHasPermissions['finance_manage_register_list_audit']" type="success">终审通过</el-button>
						</div>
					</li>
					<li v-if="checkHeadData.status==='PENDING'">
						<div class="fk_btn_box">
							<el-button @click="doReject " v-if="!roleHasPermissions['finance_manage_register_list_audit']" type="danger">终审拒绝</el-button>
						</div>
					</li>
					<!--<li>
						<div class="fk_btn_box">
		...
		methods: {
			...
			getQueryRecheckData() { //复审授信结论-查询
			   ...
			   getQueryScorecardQuery(){//评级打分卡-查询
			   	finalfirstDetail.scorecardTypes(this.supplierId).then(res => {
			       if (res.data.code === '200') {
