	...
	<div class="page-container" ref="page-container" id="page-container">
		...
		<div class="filter-container" ref="filter-container" id="filter-container">
				...
				<div>
					<el-form :inline="true" :model="listQuery" ref="listQueryForm">
						...
						<el-form-item>
							...
							<a :href="'/admin/back_report/export?by='+exportBy+'&date='+exportDate" target="_blank">
			...
			<el-table :data="topList" class="top_table">
				...
				<el-table-column prop="expectedBackCount" label="应还笔数">
				</el-table-column>

				<el-table-column prop="expectedBackAmount" label="应还金额">
				</el-table-column>

				<el-table-column prop="actualBackCount" label="实还笔数">
				</el-table-column>

				<el-table-column prop="actualBackAmount" label="实还金额">
				</el-table-column>

				<el-table-column prop="overdueCount" label="未还笔数">
				</el-table-column>

				<el-table-column prop="overdueAmount" label="未还金额">
				</el-table-column>
...
<script>
	...
	import { total, getListData, collateralRegisterStatus } from '@/api/statementManage/backReportList'
