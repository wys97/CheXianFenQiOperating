    ...
    <div class="content" >
      <div   style="width:100%">
        <el-tabs type="card" @tab-click="handleClick"  style="width:100%">
          <el-tab-pane label="基本信息"  style="width:100%">
            <el-form
              ref="form"
              label-width="180px"
              size="small"
          ...
          <el-tab-pane label="分期申请信息" v-if="states.isHasOrderInfo">
            ...
            >
              <el-form-item label="业务员：">
                <span v-if="installmentData">{{this.installmentData.name}}</span>
              </el-form-item>
              <el-form-item label="上传投保单：">
                <img v-if="installmentData" :src="this.installmentData.insuranceUrl" class="img" />
              </el-form-item>
              <el-form-item label="投保企业名称：">
                <span v-if="installmentData">{{this.installmentData.policyCompanyName}}</span>
              </el-form-item>
              <el-form-item label="投保企业信用代码：">
                <span v-if="installmentData">{{this.installmentData.companyCreditCode}}</span>
              </el-form-item>
              <el-form-item label="保险公司：">
                <span v-if="installmentData">{{this.installmentData.companyName}}</span>
              </el-form-item>
              <el-form-item label="收款机构：">
                <span v-if="installmentData">{{this.installmentData.receiveNameShort}}</span>
              </el-form-item>
              <el-form-item label="产品名称：" style="margin-top:30px">
                <span v-if="installmentData">{{this.installmentData.productName}}</span>
              </el-form-item>
              <el-form-item label="分期期数：">
                <span v-if="installmentData">{{this.installmentData.installmentNum}}期</span>
              </el-form-item>
              <el-form-item label="金融信息服务费：">
                <span v-if="installmentData">{{this.installmentData.onlineRate}}% （线上服务费） {{this.installmentData.offlineRate}}%（线下服务费）</span>
              </el-form-item>
              <el-form-item label="商业险金额：">
                <span v-if="installmentData">{{this.installmentData.installmentAmount}}元</span>
              </el-form-item>
              <el-form-item label="交强险金额：">
                <span>{{this.installmentData.strongAmount}}元</span>
              </el-form-item>
              <el-form-item label="车船税金额：">
                <span v-if="installmentData">{{this.installmentData.taxAmont}}元</span>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          ...
          <el-tab-pane label="还款计划" v-if="states.isHasRepaymentPlan">
            ...
            >
              ...
              <el-form-item label="业务单号：">
               <span v-if="planInfo">{{this.planInfo.orderNo}}</span>
              </el-form-item>
              <el-form-item label="分期总额：">
               <span v-if="planInfo">{{this.planInfo.installmentAmount}}元</span>
              </el-form-item>
              <el-form-item label="分期期数：">
               <span v-if="planInfo">{{this.planInfo.installmentNum}}期</span>
                
              </el-form-item>
              <el-form-item label="申请时间：">
                <span v-if="planInfo">{{this.planInfo.applyTime}}</span>
              </el-form-item>
              <el-form-item label="放款时间：">
                <span v-if="planInfo">{{this.planInfo.payEndTime}}</span>
              </el-form-item>
              <hr style="width:160%" />
              <el-form-item label="首付金额：">
                 <span v-if="planInfo">{{this.planInfo.firstAmount}}元</span>
              </el-form-item>
              <el-form-item>
                <div v-if="planInfo">交强险 {{this.planInfo.strongAmount}}元+车船税 {{this.planInfo.taxAmont}}元+保证金 {{this.planInfo.depositAmount}}元+线上服务费 {{this.planInfo.onlineServiceCharge}}元 
            ...
            <el-table :data="orderPlanList" v-if="orderPlanList.length>0" border style="width: 50%; margin:0 0 0 280px">
