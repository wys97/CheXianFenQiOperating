...
<!---商户管理-商户入驻--->
  <div class="page-container" ref="page-container" id="page-container" style="padding-top: 30px;overflow-y: auto;">
		  			...
		  			<el-col :span="8">
		  				...
		  				<p class="h_amt">
		  					<router-link to="/supplierManage/supplierRegister" class="router-link">
		  						{{backlogData.pendingMerchants||backlogData.pendingMerchants===0?backlogData.pendingMerchants:'-'}}
		  					</router-link>
		  				</p>
		  			</el-col>
		  			<el-col :span="8">
		  				...
		  				<p class="h_amt">
		  					<router-link to="/financeManage/financeAudit" class="router-link">
		  						{{backlogData.pendingFinanceOrders||backlogData.pendingFinanceOrders===0?backlogData.pendingFinanceOrders:'-'}}
		  					</router-link>
		  				</p>
		  			</el-col>
		  			<el-col :span="8">
		  				<p class="h_name">贷中异常预警（条）</p>
		  				<p class="h_amt">{{backlogData.alertNum||backlogData.alertNum===0?backlogData.alertNum:'-'}}</p>
		  			</el-col>
		  		</el-row>
		  	</div>
		  </el-col>
			  	...
			  	<el-row>
					  <el-col :span="5">
					  	<div class="">
					  		...
					  		<p class="h_amt">{{statisticsData.merchantNum||statisticsData.merchantNum===0?statisticsData.merchantNum:'-'}}</p>
					  	</div>
					  </el-col>
					  <el-col :span="7">
					  	<div class="">
					  		<p class="h_name">累计融资总笔数（笔）</p>
					  		<p class="h_amt">{{statisticsData.financeOrderNum||statisticsData.financeOrderNum===0?statisticsData.financeOrderNum:'-'}}</p>
					  	</div>
					  </el-col>
					  <el-col :span="5">
					  	<div class="">
					  		...
					  		<p class="h_amt">
						  		<router-link to="/capticalManage/capticalList" class="router-link">
			  						{{statisticsData.capitalNum||statisticsData.capitalNum===0?statisticsData.capitalNum:'-'}}
			  					</router-link>
		  					</p>
					  	</div>
					  </el-col>
					  <el-col :span="7">
					  	<div class="">
					  		...
					  		<p class="h_amt">{{statisticsData.totalFinanceAmount||statisticsData.totalFinanceAmount===0?statisticsData.totalFinanceAmount:'-'}}</p>
					  	</div>
					  </el-col>
					</el-row>
		  	</div>
		  	...
		  	<div class="h_top">
		  		...
		  		<el-row>
		  			<el-col :span="6">
		  				...
		  				<p class="h_amt">{{collectionStatisticsData.count||collectionStatisticsData.count===0?collectionStatisticsData.count:'-'}}</p>
		  			</el-col>
		  			<el-col :span="6">
		  				<p class="h_name">待收本金（元）</p>
		  				<p class="h_amt">{{collectionStatisticsData.amount||collectionStatisticsData.amount===0?collectionStatisticsData.amount:'-'}}</p>
		  			</el-col>
		  			<el-col :span="6">
		  				<p class="h_name">待收总额（元）</p>
		  				<p class="h_amt">{{collectionStatisticsData.totalAmount||collectionStatisticsData.totalAmount===0?collectionStatisticsData.totalAmount:'-'}}</p>
		  			</el-col>
		  			<el-col :span="6">
		  				<p class="h_name">待收利息（元）</p>
		  				<p class="h_amt">{{collectionStatisticsData.interest||collectionStatisticsData.interest===0?collectionStatisticsData.interest:'-'}}</p>
		  			</el-col>
		  		</el-row>
		  	</div>
		  </el-col>
			  	...
			  	<el-row>
					  <el-col :span="6">
					  	<div class="">
					  		...
					  		<p class="h_amt">{{overdueStatisticalData.count||overdueStatisticalData.count===0?overdueStatisticalData.count:'-'}}</p>
					  	</div>
					  </el-col>
					  <el-col :span="6">
					  	<div class="">
					  		<p class="h_name">逾期本金（元）</p>
					  		<p class="h_amt">{{overdueStatisticalData.amount||overdueStatisticalData.amount===0?overdueStatisticalData.amount:'-'}}</p>
					  	</div>
					  </el-col>
					  <el-col :span="6">
					  	<div class="">
					  		<p class="h_name">逾期总额（元）</p>
					  		<p class="h_amt">{{overdueStatisticalData.totalAmount||overdueStatisticalData.totalAmount===0?overdueStatisticalData.totalAmount:'-'}}</p>
					  	</div>
					  </el-col>
					  <el-col :span="6">
					  	<div class="">
					  		<p class="h_name">逾期利息（元）</p>
					  		<p class="h_amt">{{overdueStatisticalData.interest||overdueStatisticalData.interest===0?overdueStatisticalData.interest:'-'}}</p>
					  	</div>
					  </el-col>
					</el-row>
		  	</div>
	...
	<!-- <div class="hint">欢迎来到，车险分期联合运营系统</div> -->
  </div>
</template>
